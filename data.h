...
std::string datafilename = "INPUT/SCOTUS_n9_N895_Data.dat"; //"INPUT/sampled.dat";
...
const std::string communityfile = "INPUT/SCOTUS_Communities_inBestBasis.dat"; //"INPUT/community.dat";
